...
import InsuranceDestination from './container/payment/InsuranceDestination'
import CreditCardType from './container/payment/CreditCardType'

import AccountScreen from './container/account/Account';
import AboutUs from './container/account/AboutUs';
import ChangePIN from './container/account/ChangePIN';
...
function PaymentStackScreen() {
    return (
        ...
        >
            ...
            <Stack.Screen name="InsuranceDestination" component={InsuranceDestination} options={{ headerShown: false }}></Stack.Screen>
            <Stack.Screen name="CreditCardType" component={CreditCardType} options={{ headerShown: false }}></Stack.Screen>
        </Stack.Navigator>
    );
...
function AccountStackScreen() {
    return (
        ...
        >
            <Stack.Screen name="Account" component={AccountScreen} options={{ title: 'Account' }}></Stack.Screen>
            <Stack.Screen name="AboutUs" component={AboutUs} options={{ title: 'About Us' }}></Stack.Screen>
            <Stack.Screen name="ChangePIN" component={ChangePIN} options={{ title: 'Change PIN' }}></Stack.Screen>
        </Stack.Navigator>
    );
